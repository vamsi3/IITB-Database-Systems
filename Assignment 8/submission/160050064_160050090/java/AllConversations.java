...
public class AllConversations extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String query = 
				...
				"temp(uid, last_timestamp, num_msgs) as " +
				" (select case " + 
				...
				"select temp.uid, coalesce(temp.last_timestamp,\'2000-01-01\') as last_timestamp, coalesce(temp.num_msgs,0) as num_msgs, Users.name " +
				"from temp, Users "+
